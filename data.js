...
export const HAPPY = [
  ...
  { id:'hulagrill', name:'Hula Grill', area:'kaanapali', where:'Whalers Village, on the sand',
    ...
    prices:[ ['Barefoot Bar pupus','$9–15'], ['Draft beer','$6–8'], ['Mai tai','$12–14'] ],
    note:'The Barefoot Bar is toes-in-sand and first-come — no reservations. Best sunset seat at Whalers Village.',
    dist:{ kaanapali:[0.3, 6], wailea:[36, 62] } },
  ...
  { id:'leilanis', name:'Leilani\'s on the Beach', area:'kaanapali', where:'Whalers Village',
    ...
    days:'Mon, Thu–Sun', from:'15:00', to:'17:00', confidence:'check',
    prices:[ ['Beachside Grill pupus','$8–14'], ['Draft beer','$6'], ['Well drinks','$8'] ],
    note:'Listings show it dark Tue/Wed for happy hour — worth a call. Downstairs Beachside Grill is the casual half.',
    dist:{ kaanapali:[0.3, 6], wailea:[36, 62] } },

  { id:'dukes-hh', name:'Duke\'s Beach House · Barefoot Bar', area:'kaanapali', where:'Honua Kai, Kāʻanapali North',
    lat:20.9432, lon:-156.6870, phone:'+18086622900', phoneLabel:'(808) 662-2900',
    days:'Daily', from:'14:30', to:'17:00', confidence:'check',
    prices:[ ['Barefoot Bar menu','$10–18'], ['Mai tai','$13'], ['Draft beer','$7'] ],
    note:'You already have a 6:30 dinner reservation here Aug 29. The Barefoot Bar is walk-in only — come early, drink downstairs, then go up.',
    dist:{ kaanapali:[2.5, 8], wailea:[34, 58] }, linkedTo:'2026-08-29' },
  ...
  { id:'pailolo', name:'Pailolo Bar & Grill', area:'kaanapali', where:'Westin Kāʻanapali Ocean Resort Villas',
    ...
    prices:[ ['Pupus','$8–14'], ['Draft beer','$6'], ['Cocktails','$10'] ],
    note:'Three-hour window, one of the longest on this coast. Sports on, less scene than Whalers Village.',
  ...
  { id:'cliffdive', name:'Cliff Dive Grill', area:'kaanapali', where:'Sheraton Maui, at Black Rock',
    ...
    days:'Daily', from:'15:00', to:'16:00', confidence:'check',
    prices:[ ['Pupus','$10–16'], ['Cocktails','$12'] ],
    note:'One-hour window only. Sits directly under the Black Rock cliff-diving ceremony at sunset — that is the reason to be here.',
...
export const EATS = [
  ...
  { id:'dukes-eat', name:'Duke\'s Beach House', area:'West Maui', where:'Honua Kai, 130 Kai Malina Pkwy',
    ...
    tip:'Your table is held 1h 30m for a party of two, with a 5-minute grace period. Come early and drink downstairs first.',
    dist:{ kaanapali:[2.5, 8], wailea:[34, 58] }, hh:'dukes-hh', booked:true },
